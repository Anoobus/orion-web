...
namespace orion.web.Reports
{
    public interface IReportWriter
    {
        ...
        (MemoryStream Steam, string MimeType, string Name) GetFinishedResult<T>(T reportSettings, ReportDTO<EmployeeTimeReportDTO> rpt) where T : new();
    }
    public class ReportWriter : IReportWriter, IAutoRegisterAsSingleton
    {
        ...
        public (MemoryStream Steam, string MimeType, string Name) GetFinishedResult<T>(T reportSettings, ReportDTO<EmployeeTimeReportDTO> rpt) where T : new()
        {
